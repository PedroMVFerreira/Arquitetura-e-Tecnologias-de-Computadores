...
void config (void) __using (1)
{
	...
	TMOD |= 0x02; /*Iremos usar o timer 0 no modo 2 (8bit counter/timer com auto-reload)*/
...
passado 0.5 us, logo a cada transbordo (ativação da flag) terão se passado 250 ciclos e um total de 0.000125s
Logo para obtermos 1 seegundo teremos de 8000 transbordos da flag, pois 8000 * 0.000125s = 1s*/
void toggle (void) __using (1)
{
	if(contFlagTF0 == 8000){/*Passagem de 1 segundo*/
